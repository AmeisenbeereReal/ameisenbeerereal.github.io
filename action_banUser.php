...
if(isset($_POST['submit-ban'])){
    ...
    $reasonstmt = getMySQL()->prepare("SELECT * FROM prime_bungee_punishments WHERE type='BAN' AND identifier=:iden");
    ...
    $stmt = getMySQL()->prepare("INSERT INTO prime_bungee_bans VALUES (id,:uuid,:reason,:lenght,:timestamp,:issuer,0)");
    ...
    sendSocketCheckBanCommand($_SESSION['uuid']);

    addHistory($uuid, "BAN", $reason, $timestring, $_SESSION['uuid']);
