...
class SQLBan
{
    ...
    public static function fromId($id){
        ...
        $stmt = getMySQL()->prepare("SELECT * FROM prime_bungee_bans WHERE id = :id");
    ...
    public static function fromPlayerActive($uuid){
        ...
        $stmt = getMySQL()->prepare("SELECT * FROM prime_bungee_bans WHERE uuid = :uuid AND revoked = 0 AND (lenght >= :time OR lenght = -1)");
